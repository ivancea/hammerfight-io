...
import { availableInputHandlers, InputHandlerId } from "../input/input-handler-catalog";
...
export class FormUiState extends BaseUiState {
  ...
  doEnter() {
    ...
    document.getElementById("room-selection-form-submit")?.addEventListener("click", (event) => {
      ...
      this.resolve(new GameUiState(username, inputHandlerId, weapon, bots, debugMode));
    });
  }
  ...
  private initializeForm() {
    ...
    this.inputModeInput = document.getElementById("input-mode") as HTMLSelectElement;
    ...
    this.debugModeInput = document.getElementById("debug-mode") as HTMLInputElement;
